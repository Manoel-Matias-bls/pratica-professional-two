$(document).ready(function(){
    $('input.campoplaca').inputmask("AAA-9999", {'removeMaskOnSubmit' : false});
    $('input.campotelefone').inputmask("(99) 99999-9999", {'removeMaskOnSubmit' : true});
    $('input.campodata').inputmask("99/99/9999", {'removeMaskOnSubmit' : false});
    ...
    $('input.campodinheiro').inputmask("currency", {radixPoint: ',', prefix: 'R$ '});
});